function icplayer() {
  var P = "",
    ...
    _ = "/",
    lb = "//",
    Qb = "2BC4708001A9F3B43A62851FC1578A18",
    Rb = "34C1B46C61EC39D7AC9941459A66F089",
    Ub = ":",
    pb = "::",
    jc = "<script defer=\"defer\">icplayer.onInjectionDone('icplayer')</script>",
    hb = '<script id="',
    fc = '<script language="javascript" src="',
    sb = "=",
    $ = "?",
    Sb = "AE04E7B9BF9E39066F7A3B0DC0963E51",
    ub = 'Bad handler "',
    dc = "DOMContentLoaded",
    Tb = "FE9F42C3C03FB939B8E684AF92C71568",
    jb = "SCRIPT",
    gb = "__gwt_marker_icplayer",
    kb = "base",
    cb = "baseUrl",
    T = "begin",
    S = "bootstrap",
    ec = "build/dist/libs.min.js",
    gc = 'build/dist/libs.min.js"></script>',
    bb = "clear.cache.gif",
    rb = "content",
    Y = "end",
    Kb = "gecko",
    ...
    qb = "gwt:property",
    _b = "head",
    Ob = "hosted.html?icplayer",
    $b = "href",
    Q = "icplayer",
    eb = "icplayer.nocache.js",
    ob = "icplayer::",
    Jb = "ie6",
    Ib = "ie8",
    Hb = "ie9",
    ...
    ab = "img",
    zb = "javascript:''",
    cc = "libs/TreeGrid/css/jquery.treegrid.css",
    bc = "libs/jquery-ui.css",
    hc = "libs/tinymce.min.js",
    ic = 'libs/tinymce.min.js"></script>',
    Xb = "link",
    Nb = "loadExternalRefs",
    mb = "meta",
    Bb = "moduleRequested",
  ...
  function J() {
    if (!I) {
      ...
      jQuery(document).ready(function ($) {
        $.get(t+L, function (data) {
          // Add to iframe, if only the iframe still exists
          if (a && a.contentWindow && a.contentWindow.document) {
            a.contentWindow.document.open();
            if (window.MSApp && window.MSApp.execUnsafeLocalFunction) {
              window.MSApp.execUnsafeLocalFunction(function () {
                ab.contentWindow.document.write(data);
              });
            } else {
              a.contentWindow.document.write(data);
            }
  ...
  v[Cb] = { gecko1_8: 0, ie6: 1, ie8: 2, ie9: 3, opera: 4, safari: 5 };
  icplayer.onScriptLoad = function () {
    if (I) {
      r = true;
      C();
    }
  };
  icplayer.onInjectionDone = function () {
    q = true;
    o && o({ moduleName: Q, sessionId: p, subSystem: R, evtGroup: Nb, millis: new Date().getTime(), type: Y });
    C();
  };
  E();
  D();
  ...
  o && o({ moduleName: Q, sessionId: p, subSystem: R, evtGroup: S, millis: new Date().getTime(), type: Pb });
  if (!B()) {
    try {
      G([Hb], Qb);
      G([Fb], Rb);
  ...
  function O() {
    if (!s) {
      ...
      if (!__gwt_stylesLoaded[Wb]) {
        var a = n.createElement(Xb);
        __gwt_stylesLoaded[Wb] = a;
        a.setAttribute(Yb, Zb);
        a.setAttribute($b, t + Wb);
        n.getElementsByTagName(_b)[0].appendChild(a);
      }
      if (!__gwt_stylesLoaded[Wb]) {
        var a = n.createElement(Xb);
        __gwt_stylesLoaded[Wb] = a;
      ...
      if (!__gwt_stylesLoaded[ac]) {
        ...
        a.setAttribute(Yb, Zb);
        a.setAttribute($b, t + ac);
        n.getElementsByTagName(_b)[0].appendChild(a);
      }
      if (!__gwt_stylesLoaded[bc]) {
        var a = n.createElement(Xb);
        __gwt_stylesLoaded[bc] = a;
        a.setAttribute(Yb, Zb);
        a.setAttribute($b, t + bc);
        n.getElementsByTagName(_b)[0].appendChild(a);
      }
      if (!__gwt_stylesLoaded[cc]) {
        var a = n.createElement(Xb);
        __gwt_stylesLoaded[cc] = a;
        a.setAttribute(Yb, Zb);
        a.setAttribute($b, t + cc);
        n.getElementsByTagName(_b)[0].appendChild(a);
      }
      C();
      if (n.removeEventListener) {
        n.removeEventListener(dc, O, false);
      }
      if (N) {
        clearInterval(N);
      }
  ...
  o && o({ moduleName: Q, sessionId: p, subSystem: R, evtGroup: Nb, millis: new Date().getTime(), type: T });
  if (!__gwt_scriptsLoaded[ec]) {
    __gwt_scriptsLoaded[ec] = true;
    document.write(fc + t + gc);
  }
  if (!__gwt_scriptsLoaded[hc]) {
    __gwt_scriptsLoaded[hc] = true;
    document.write(fc + t + ic);
  }
  n.write(jc);
}
icplayer();
